...
import { CompleteHospital, RelatedHospitalModel, CompleteUser, RelatedUserModel, CompleteAppointment, RelatedAppointmentModel, CompleteReport, RelatedReportModel, CompleteDoctorSlot, RelatedDoctorSlotModel, CompletePrescription, RelatedPrescriptionModel } from "./index"
